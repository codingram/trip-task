...
.card-hotel-descriptionSide {
  ...
  .card-hotel-image-slider {
    ...
    .swiper-slide {
      ...
      &.slide-1 {
        width: 100%;
        background-image: url("../../assets/imagesR/backimage.jpg");
      }
      &.slide-2 {
        width: 100%;
        background-image: url("../../assets/imagesR/backimage.jpg");
  ...
  .card-hotel-deals {
    border-top: 1px solid $dimmerfont;
    // padding-top: 10px;
    .deal-logo {
      background-color: $dimfont;
      color: #fff;
